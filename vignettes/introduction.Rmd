...
The object `DB` returned by the function is a database connection pool (an object of class `Pool` defined in the `pool` package). We can use it to import data into the database and, later, to query records in the database.
